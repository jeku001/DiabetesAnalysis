...
from mlxtend.feature_selection import \
    SequentialFeatureSelector  ## changed source file: https://github.com/rasbt/mlxtend/issues/1100
...
# Load your dataset (assuming df_binary is your DataFrame)
data = df_binary
...
## analiza klasteryzacxji, czy prediabetes i diabetes to to samo
